...
const en = {
  ...
  noWalletFound: 'No Midnight wallet found (Lace or 1AM).',
  walletConnectionLost: 'Wallet connection lost. Reload the page and try again.',
  connectionFailed: 'Connection failed',
  laceSlowHint: 'The wallet is starting up, the authorization popup will appear shortly',
...
const es: typeof en = {
  ...
  noWalletFound: 'No se encontró ninguna wallet de Midnight instalada (Lace o 1AM).',
  walletConnectionLost: 'Conexión con la wallet perdida. Recarga la página e inténtalo de nuevo.',
  connectionFailed: 'Error de conexión',
  laceSlowHint: 'La wallet está iniciando, el popup de autorización aparecerá en breve',
